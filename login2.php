...
<div class="container mt-5">
    ...
    <p class="text-center mt-2 fs-2 text-muted">Welcome back!</p>
    ...
    <form action="" class="w-75" method="post" style="margin:0 auto;" onsubmit="return validateLogin()">
        ...
        <div class="d-grid gap-2 col-6 mx-auto mt-5 ">
            <button class="btn btn-success rounded-5 fs-3" type="submit" name="submit" style="background-color:dark ;">login</button>
        </div>
    </form>
</div>
